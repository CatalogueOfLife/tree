...
var Tree = /*#__PURE__*/function (_React$Component) {
  ...
  function Tree() {
    ...
    _this.onNodeDragStart = function (event, node) {
      ...
      if (onDragStart) {
        onDragStart({
          ...
          cleanDragState: _this.cleanDragState
        });
      }
    };
    /**
    ...
    _this.onNodeDragEnter = function (event, node) {
      ...
      var indent = _this.listRef.current.getIndentWidth();
      ...
      if ( // !dragNode || // We should allow drop if dragNode is undefined - it could come from another tree
    ...
    _this.onNodeDragOver = function (event, node) {
      ...
      if ( // !dragNode || Allow drop from another tree (dragNode is undefined)
      dragChildrenKeys.indexOf(dropTargetKey) !== -1 || !dropAllowed) {
        // don't allow drop inside its children
    ...
    _this.onNodeDrop = function (event, node) {
      ...
      var dropResult = {
        ...
        dragNodesKeys: _this.dragNode ? [_this.dragNode.props.eventKey].concat(dragChildrenKeys) : [],
